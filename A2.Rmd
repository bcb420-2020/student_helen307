...
I have shown the up and down-regulated genes in a volcano plot by coloring them in red and blue, the code is from [an example analysis on tomato data](http://www.nathalievialaneix.eu/doc/html/solution_edgeR-tomato.html#volcano-plot)
```{r up_volcano}
...
* The paper found 1401 genes being up-regulated with fold change > 2 and FDR < 0.05. I found 1312 which is roughly similar.
* The paper also found that ALDH family is up-regulated as well. But I found 3 of them in my upregulated genes.
* The disease is indicated as 31% of basal-like tumors, 12% (HER2)+ tumors and 10% of luminal tumors, since the top terms of my upregulated genes are metabolic processes, the result aligns with the paper.
...
* [Vassalli 2019](https://www.hindawi.com/journals/sci/2019/3904645/) considers ALDH family as a biomarker for breast cancer.
* [Vasiliou 2005](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3525259/) convinces me that my result from g:profiler matches with the basal subtype. The paper states that mutations in ALDH genes causes metabolism errors, for example, Sjögren - Larsson syndrome, type II hyperprolinaemia and γ-hydroxybutyric aciduria and even cancer and Alzheimer's disease. 
