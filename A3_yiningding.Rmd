...
```{r, echo=FALSE}
pos <- read.delim("/Users/helending/Documents/bcb420/A3_part1_non_thres.GseaPreranked.1584469398976/gsea_report_for_na_pos_1584469398976.xls")
...
```{r, echo=FALSE}
neg <- read.delim("/Users/helending/Documents/bcb420/A3_part1_non_thres.GseaPreranked.1584469398976/gsea_report_for_na_neg_1584469398976.xls")
kable(head(neg[,c(1, 4, 5, 6, 7, 8, 9, 10, 11)]), caption = "Down-regulated_top_terms", format="html") %>%
  kable_styling(bootstrap_options = "hover")
```
